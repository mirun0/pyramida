...
CREATE TABLE IF NOT EXISTS `cinema`.`film_screening` (
  ...
  PRIMARY KEY (`id`, `FK_hall`, `FK_film`),
...
CREATE TABLE IF NOT EXISTS `cinema`.`booking` (
  ...
  PRIMARY KEY (`id`, `FK_user`, `FK_screening`),
...
CREATE TABLE IF NOT EXISTS `cinema`.`film_has_dubbing` (
  ...
  PRIMARY KEY (`FK_film`, `language_id`),
...
CREATE TABLE IF NOT EXISTS `cinema`.`film_has_subtitles` (
  ...
  PRIMARY KEY (`FK_film`, `FK_language`),
